...
def get_args():
    ...
    parser.add_argument("--vad_segments_file", type=str,
                        help="""Input kaldi segments file""")
    parser.add_argument("--out_subsegments_file", type=str,
...
def run(vad_segments_file, out_subsegments_file, max_segment_duration, overlap_duration, max_remaining_duration, constant_duration, *args, **kwargs):
